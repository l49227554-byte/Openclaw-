...
private fun webThemePalette(
  ...
  when (family) {
    ...
    AppearanceThemeFamily.Lobster -> {
      if (dark) {
        WebThemePalette(0xFF071214, 0xFF0A171A, 0xFF0E1D20, 0xFF142A2E, 0xFFF5764A, 0xFF173135, 0xFF234A4F, 0xFFDCCFBF, 0xFF8AA19F, 0xFFF5764A, 0xFF2B0D04, 0xFF3FD1C0)
      } else {
        WebThemePalette(0xFFF4EFE6, 0xFFEDE6DA, 0xFFFBF8F2, 0xFFE3DCCF, 0xFFB83C16, 0xFFD8CFBF, 0xFFBFB3A0, 0xFF2A3638, 0xFF475A5C, 0xFFB83C16, 0xFFFFF6EE, 0xFF0F8B83)
      }
    }
  }
