...
| Hook                            | Kind    | Purpose                                                                                                     |
| ------------------------------- | ------- | ----------------------------------------------------------------------------------------------------------- |
| `before_model_resolve`          | Modify  | Classify the prompt before session messages load; optionally return an atomic provider/model/effort route and a host-delivered pre-dispatch notice |
