...
shared read-only worker owner. Each uncached load captures its library state
context before workspace preparation and publishes combined entries only after
