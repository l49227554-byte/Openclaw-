...
import {
  createDoctorContext,
  legacyMemoryIndexMigration,
  dreamingStateMigration,
  hostEventsMigration,
  qmdFileLockMigration,
  qmdWorkspaceMigration,
  vectorToBlob,
  writeLegacyMemorySidecar,
  createCanonicalMemoryIndex,
  createUnrelatedCanonicalMemoryIndex,
  createCanonicalLegacyMemoryRowsWithFts,
  createMismatchedCanonicalVectorIndex,
  createConflictingCanonicalVectorIndex,
  readMemoryRows,
  readMemoryCacheRows,
  readMemoryFtsSql,
  searchMigratedVectorRows,
  searchMigratedKeywordRows,
