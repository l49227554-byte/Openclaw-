...
export class TelegramPollingSession {
  ...
  async #createPollingBot(): Promise<TelegramBot | undefined> {
    ...
    try {
      ...
      // factory performs its compatibility cold read. Loaded lazily from the
      // state module so the manager/sweeper graph stays out of the polling
      // transport's import graph, mirroring Discord's channel.loaders.ts.
