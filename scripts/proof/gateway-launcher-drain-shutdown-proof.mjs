#!/usr/bin/env node
// Real Node launcher boundary proof for the managed Linux Gateway service contract.
...
if (process.platform !== "linux") {
  throw new Error("This proof establishes only the managed Linux service contract.");
}
