// Harness auth-profile selection for a command run attempt, split out of
// attempt-execution.ts to keep that grandfathered orchestration file within its line
// cap. Resolves which auth profile (session-pinned or harness-forwarded) a runtime
// attempt should present, reading the agent's credential store.
