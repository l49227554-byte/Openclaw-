...
import type { CronJob } from "../../cron/types.js";import { defaultRuntime } from "../../runtime.js";
...
async function waitForCronRunCompletion(params: {
  ...
  for (;;) {
    ...
    const page = readGatewayShape<{ entries?: CronRunLogEntryResult[] }>(pageRaw);    const entry = page.entries?.[0];
