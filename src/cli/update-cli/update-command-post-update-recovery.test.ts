import "./update-command-post-update-recovery.test-support.js";
...
const { failedResult, finishFailedUpdate, finishSkippedUpdate, mocks, tempDirs } =
  await import("./update-command-post-update-recovery.test-support.js");
