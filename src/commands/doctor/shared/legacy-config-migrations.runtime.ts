...
import { LEGACY_CONFIG_MIGRATION_AGENTS_BLANK_AGENTDIR } from "./legacy-config-migrations.runtime.agents-blank-agentdir.js";
...
export const LEGACY_CONFIG_MIGRATIONS_RUNTIME: LegacyConfigMigrationSpec[] = [
  ...
  LEGACY_CONFIG_MIGRATION_AGENTS_BLANK_AGENTDIR,
