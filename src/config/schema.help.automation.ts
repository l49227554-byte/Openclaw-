...
export const AUTOMATION_FIELD_HELP: Record<string, string> = {
  ...
  "messages.groupChat.historyLimit":
    "Maximum number of prior group messages loaded as context per turn for group sessions. Use higher values for richer continuity, or lower values for faster and cheaper responses. The JSON integer maximum is treated as unset so the default bound applies.",
