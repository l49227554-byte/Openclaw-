        ...
        try {
          ...
          if (explicitClose) {
            await expect(outcome).resolves.toMatchObject({
              status: "rejected",
              error: expect.objectContaining({ message: "Agent database Worker owner is closed" }),
            });
          ...
          // The final projection committed before the ACK gate, even if retirement rejects the sweep.
