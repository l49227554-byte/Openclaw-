...
describe("retained legacy ACP metadata", () => {
  ...
  it("does not republish stale ACP metadata beside a canonical metadata edit", async () => {
  ...
  it("does not recreate stored ACP metadata for a deleted canonical session", async () => {
