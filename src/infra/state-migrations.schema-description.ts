import type { OpenClawStateDatabaseSchemaMigration } from "../state/openclaw-state-db-contract.js";
...
export function describeStateSchemaMigration(
  ...
  switch (migration.kind) {
    ...
    case "worktree-session-bindings-v18":
      return "session-owned worktrees → explicit memberships";
