...
const enSidebarAttention = {
  ...
  attention: {
    ...
    outbox: {
      ...
      commandUnconfirmed: "Command unconfirmed",
      review: "Review in chat",
      reviewShort: "Review",
      reviewHint: "Review this browser’s pending submission in its conversation.",
      checkBeforeRetry: "It may have reached the Gateway. Check the conversation before retrying.",
